...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': {
    roles: ['business-owner', 'operations-staff', 'admin', 'manager'],
    key: 'orderId',
    tenantPath: [],
    userPath: [],
  },
...
const customerRoles: string[] = ['silver'];
const tenantRoles: string[] = ['business-owner', 'operations-staff', 'customer', 'admin', 'manager'];
